...
After generating the document, output a clean, formatted email summary of the updates separated by "Key Completions," "In Progress / Revisions," and "Open Blockers". STRIP all citation brackets (e.g., [1]) from the final email text so it is clean for copy-pasting.
